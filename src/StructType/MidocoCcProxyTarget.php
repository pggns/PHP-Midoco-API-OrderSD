...
class MidocoCcProxyTarget extends CcproxyTargetDTO
{
     ...
     * @var \Pggns\MidocoApi\OrderSD\StructType\CcproxyHandlerDTO|null
     */
    protected ?\Pggns\MidocoApi\OrderSD\StructType\CcproxyHandlerDTO $MidocoCcProxyHandler = null;
    /**
     ...
     */
    public function __construct(?\Pggns\MidocoApi\OrderSD\StructType\CcproxyHandlerDTO $midocoCcProxyHandler = null)
    {
        $this
     ...
     * @return \Pggns\MidocoApi\OrderSD\StructType\CcproxyHandlerDTO|null
     */
     ...
     */
    public function setMidocoCcProxyHandler(?\Pggns\MidocoApi\OrderSD\StructType\CcproxyHandlerDTO $midocoCcProxyHandler = null): self
    {
