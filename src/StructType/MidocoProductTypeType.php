...
class MidocoProductTypeType extends ProductTypeDTO
{
     ...
     */
    public function __construct(array $midocoProductTypeMediatorCondition = [], array $midocoProductTypeSupplier = [], ?\Pggns\MidocoApi\OrderSD\StructType\VatDivisionTemplateType $vatDivisionIn = null, ?\Pggns\MidocoApi\OrderSD\StructType\VatDivisionTemplateType $vatDivisionOut = null)
    {
        $this
